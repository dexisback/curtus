...
export const AMBIENT_SOUNDS: AmbientSound[] = [
  ...
  },
  {
    id: 'river-pro',
    label: 'Soft Waves',
    fileName: 'freesound_community-seaside-soft-waves-24405.mp3',
    tone: 'river',
    featured: true,
  },
  {
    id: 'nyc-siren',
    label: 'NYC Siren',
    fileName: 'freesound_community-siren-in-nyc-27650.mp3',
  },
  {
    id: 'railway-station',
    label: 'Railway Station',
    fileName:
      'arunangshubanerjee-indian-railway-station-ambience-crowd-chatter-and-train-arrival-331012.mp3',
  },
  {
    id: 'train-fields',
    label: 'Train Through Fields',
    fileName:
      'arunangshubanerjee-indian-train-accelerating-through-fields-child-cries-then-calms-336663.mp3',
  },
];

export const FEATURED_AMBIENT = AMBIENT_SOUNDS.filter((s) => s.featured);
export const DEVELOPER_LIKES_AMBIENT = AMBIENT_SOUNDS.filter(
  (s) => !s.featured,
);
