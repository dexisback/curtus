...
function LoginPageContent() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background">
      <div className="w-full max-w-sm border border-border rounded-xl p-8 flex flex-col gap-5 shadow-sm bg-card">
        <div className="flex flex-col gap-1">
          <h1 className="text-lg font-semibold text-foreground">Sign in to StudyWithMe</h1>
          <p className="text-xs text-muted-foreground">Choose a provider to continue</p>
        </div>
        ...
        <div className="flex flex-col gap-2.5">
          ...
          >
            <svg width="16" height="16" viewBox="0 0 24 24" aria-hidden="true" suppressHydrationWarning>
